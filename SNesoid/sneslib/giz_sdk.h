...
#define INP_BUTTON_LEFT				(0)
#define INP_BUTTON_RIGHT			(1)
#define INP_BUTTON_UP				(2)
#define INP_BUTTON_DOWN				(3)
#define INP_BUTTON_STOP				(4)
#define INP_BUTTON_PLAY				(5)
#define INP_BUTTON_FORWARD			(6)
#define INP_BUTTON_REWIND			(7)
#define INP_BUTTON_L				(8)
#define INP_BUTTON_R				(9)
#define INP_BUTTON_HOME				(10)
#define INP_BUTTON_VOL				(11)
#define INP_BUTTON_BRIGHT			(12)
#define INP_BUTTON_TRIANGLE			(13) 
#define INP_BUTTON_POWER			(14) 
